...
COPY faculties
FROM '/home/dylan/Project-1/faculties.csv'
DELIMITER ','
CSV HEADER;

COPY programs
FROM '/home/dylan/Project-1/programs.csv'
DELIMITER ','
CSV HEADER;

COPY instructors
FROM '/home/dylan/Project-1/instructors.csv'
DELIMITER ','
CSV HEADER;

COPY courses
FROM '/home/dylan/Project-1/courses.csv'
DELIMITER ','
CSV HEADER;

COPY pre_requisties
FROM '/home/dylan/Project-1/pre_reqs.csv'
DELIMITER ','
CSV HEADER;

COPY courses_programs
FROM '/home/dylan/Project-1/courses_programs.csv'
DELIMITER ','
CSV HEADER;
...
--what programss does Mrs.vernelle offer
...
SELECT P.program_name, P.program_id,C.code, C.year, C.semester, C.section, C.title AS course_name
FROM programs AS P
JOIN courses_programs AS CP
